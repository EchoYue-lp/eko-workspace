...
记录的 R1/P0 bounded-query residual 也未宣称解决。child mains 已与 `origin/main` 对齐；
top-level superproject commit 尚未 push/release。下一阶段是 F6/R1 与剩余 lifecycle/persistence 收口。
